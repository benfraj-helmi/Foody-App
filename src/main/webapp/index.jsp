...
<body>
            ...
            <div class="col-lg-4 text-center bg-primary border-inner py-3">
                <div class="d-inline-flex align-items-center justify-content-center">
                    <a href="index.jsp" class="navbar-brand">
                        <h1 class="m-0 text-uppercase text-white">Foody</h1>
                    </a>
                </div>
            </div>
            <div class="col-lg-4 text-center bg-secondary py-3">
        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    ...
                    <h1 class="display-1 text-uppercase text-white mb-4">Foody</h1>
                    <h1 class="text-uppercase text-white">The Best FastFood Delivery  App</h1>
        ...
        <div class="container">
            ...
            <div class="row gx-5">
                ...
                <div class="col-lg-6 pb-5">
                    <h4 class="mb-4">Welcome To Foody App </h4>
                    <p class="mb-5">  the best delivery app in tunisia , this app was made by Mohamed Taher Ben Slama and Helmi Ben Fraj as a JEE Project Enjoy Your Navigation !!</p>
                    <div class="row g-5">
                        <div class="col-sm-6">
                            ...
                            <p class="mb-0">certified by "l'administration de santé en tunisie" </p>
                        </div>
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center justify-content-center bg-primary border-inner mb-4" style="width: 90px; height: 90px;">
                                <i class="fa fa-award fa-2x text-white"></i>
                            </div>
                            <h4 class="text-uppercase">Award</h4>
                            <p class="mb-0">application de l'anneé en isims 2024 </p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- [Include additional content from the original HTML here...] -->
